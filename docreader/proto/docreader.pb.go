...
func (x *CompareSplittersRequest) Reset() {
	*x = CompareSplittersRequest{}
	mi := &file_docreader_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompareSplittersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompareSplittersRequest) ProtoMessage() {}

func (x *CompareSplittersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_docreader_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompareSplittersRequest.ProtoReflect.Descriptor instead.
func (*CompareSplittersRequest) Descriptor() ([]byte, []int) {
	return file_docreader_proto_rawDescGZIP(), []int{3}
}

func (x *CompareSplittersRequest) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *CompareSplittersRequest) GetChunkSize() int32 {
	if x != nil {
		return x.ChunkSize
	}
	return 0
...
func (x *CompareSplittersRequest) GetChunkOverlap() int32 {
	if x != nil {
		return x.ChunkOverlap
	}
	return 0
...
type SplitterResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SplitterName  string                 `protobuf:"bytes,1,opt,name=splitter_name,json=splitterName,proto3" json:"splitter_name,omitempty"`
...
func (x *SplitterResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SplitterResult) ProtoMessage() {}

func (x *SplitterResult) ProtoReflect() protoreflect.Message {
	mi := &file_docreader_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SplitterResult.ProtoReflect.Descriptor instead.
func (*SplitterResult) Descriptor() ([]byte, []int) {
	return file_docreader_proto_rawDescGZIP(), []int{4}
}

func (x *SplitterResult) GetSplitterName() string {
	if x != nil {
...
func (x *SplitterResult) GetChunks() []*Chunk {
	if x != nil {
		return x.Chunks
	}
	return nil
...
func (x *SplitterResult) GetTotalChunks() int32 {
	if x != nil {
...
func (x *SplitterResult) GetExecutionTime() float64 {
	if x != nil {
...
type CompareSplittersResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Results       []*SplitterResult      `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CompareSplittersResponse) Reset() {
	*x = CompareSplittersResponse{}
	mi := &file_docreader_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompareSplittersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompareSplittersResponse) ProtoMessage() {}

func (x *CompareSplittersResponse) ProtoReflect() protoreflect.Message {
	mi := &file_docreader_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompareSplittersResponse.ProtoReflect.Descriptor instead.
func (*CompareSplittersResponse) Descriptor() ([]byte, []int) {
	return file_docreader_proto_rawDescGZIP(), []int{5}
}

func (x *CompareSplittersResponse) GetResults() []*SplitterResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *CompareSplittersResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
const file_docreader_proto_rawDesc = "" +
	...
	"\n" +
	"vlm_config\x18\x06 \x01(\v2\x14.docreader.VLMConfigR\tvlmConfig\"q\n" +
	"\x17CompareSplittersRequest\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x1d\n" +
	"\n" +
	"chunk_size\x18\x02 \x01(\x05R\tchunkSize\x12#\n" +
	"\rchunk_overlap\x18\x03 \x01(\x05R\fchunkOverlap\"\xa9\x01\n" +
	"\x0eSplitterResult\x12#\n" +
	"\rsplitter_name\x18\x01 \x01(\tR\fsplitterName\x12(\n" +
	"\x06chunks\x18\x02 \x03(\v2\x10.docreader.ChunkR\x06chunks\x12!\n" +
	"\ftotal_chunks\x18\x03 \x01(\x05R\vtotalChunks\x12%\n" +
	"\x0eexecution_time\x18\x04 \x01(\x01R\rexecutionTime\"e\n" +
	"\x18CompareSplittersResponse\x123\n" +
	"\aresults\x18\x01 \x03(\v2\x19.docreader.SplitterResultR\aresults\x12\x14\n" +
	...
	"\x03COS\x10\x01\x12\t\n" +
	"\x05MINIO\x10\x022\xfe\x01\n" +
	"\tDocReader\x12I\n" +
	"\fReadFromFile\x12\x1e.docreader.ReadFromFileRequest\x1a\x17.docreader.ReadResponse\"\x00\x12G\n" +
	"\vReadFromURL\x12\x1d.docreader.ReadFromURLRequest\x1a\x17.docreader.ReadResponse\"\x00\x12]\n" +
	"\x10CompareSplitters\x12\".docreader.CompareSplittersRequest\x1a#.docreader.CompareSplittersResponse\"\x00B5Z3github.com/Tencent/WeKnora/internal/docreader/protob\x06proto3"
...
var file_docreader_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_docreader_proto_goTypes = []any{
	...
	(*CompareSplittersRequest)(nil),  // 4: docreader.CompareSplittersRequest
	(*SplitterResult)(nil),           // 5: docreader.SplitterResult
	(*CompareSplittersResponse)(nil), // 6: docreader.CompareSplittersResponse
	(*ReadFromFileRequest)(nil),      // 7: docreader.ReadFromFileRequest
	(*ReadFromURLRequest)(nil),       // 8: docreader.ReadFromURLRequest
	(*Image)(nil),                    // 9: docreader.Image
	(*Chunk)(nil),                    // 10: docreader.Chunk
	(*ReadResponse)(nil),             // 11: docreader.ReadResponse
}
var file_docreader_proto_depIdxs = []int32{
	...
	10, // 3: docreader.SplitterResult.chunks:type_name -> docreader.Chunk
	5,  // 4: docreader.CompareSplittersResponse.results:type_name -> docreader.SplitterResult
	3,  // 5: docreader.ReadFromFileRequest.read_config:type_name -> docreader.ReadConfig
	3,  // 6: docreader.ReadFromURLRequest.read_config:type_name -> docreader.ReadConfig
	9,  // 7: docreader.Chunk.images:type_name -> docreader.Image
	10, // 8: docreader.ReadResponse.chunks:type_name -> docreader.Chunk
	7,  // 9: docreader.DocReader.ReadFromFile:input_type -> docreader.ReadFromFileRequest
	8,  // 10: docreader.DocReader.ReadFromURL:input_type -> docreader.ReadFromURLRequest
	4,  // 11: docreader.DocReader.CompareSplitters:input_type -> docreader.CompareSplittersRequest
	11, // 12: docreader.DocReader.ReadFromFile:output_type -> docreader.ReadResponse
	11, // 13: docreader.DocReader.ReadFromURL:output_type -> docreader.ReadResponse
	6,  // 14: docreader.DocReader.CompareSplitters:output_type -> docreader.CompareSplittersResponse

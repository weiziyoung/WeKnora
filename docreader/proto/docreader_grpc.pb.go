...
const (
	...
	DocReader_CompareSplitters_FullMethodName = "/docreader.DocReader/CompareSplitters"
)
...
type DocReaderClient interface {
	...
	// 对比分块效果
	CompareSplitters(ctx context.Context, in *CompareSplittersRequest, opts ...grpc.CallOption) (*CompareSplittersResponse, error)
}
...
func (c *docReaderClient) CompareSplitters(ctx context.Context, in *CompareSplittersRequest, opts ...grpc.CallOption) (*CompareSplittersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompareSplittersResponse)
	err := c.cc.Invoke(ctx, DocReader_CompareSplitters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DocReaderServer interface {
	...
	// 对比分块效果
	CompareSplitters(context.Context, *CompareSplittersRequest) (*CompareSplittersResponse, error)
...
func (UnimplementedDocReaderServer) CompareSplitters(context.Context, *CompareSplittersRequest) (*CompareSplittersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompareSplitters not implemented")
}
...
func _DocReader_CompareSplitters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompareSplittersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocReaderServer).CompareSplitters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocReader_CompareSplitters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocReaderServer).CompareSplitters(ctx, req.(*CompareSplittersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DocReader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CompareSplitters",
			Handler:    _DocReader_CompareSplitters_Handler,
		},
	},
